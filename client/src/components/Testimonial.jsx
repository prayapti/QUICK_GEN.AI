...
const Testimonial = () => {
    const dummyTestimonialData = [
        ...
        },
        {
           ...
           {
            image: "https://images.unsplash.com/photo-1587651696669-86b588f28cb4?q=80&w=725&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            name: 'shinosuke okuyama',
            title: 'TechCorp',
            content: 'ContentAI has transformed our content creation process. The AI tools have helped us produce high-quality content faster than ever before.',
            rating: 5,
        },
                ...
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                        <div className="flex items-center gap-1">
                          ...
                          src={ index < testimonial.rating ? star_icon : star_dull_icon }
