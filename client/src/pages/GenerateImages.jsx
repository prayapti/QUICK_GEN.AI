...
const GenerateImages = () => {
  ...
  const imageStyle = ['Realistic' , ' Ghibli Style', 'Anime style ' ,'Cartoon Style','3D Style' , ' Portrait Style '];
  ...
  {item}
        ...
        <div className='my-6 flex items-center gap-2'>
          ...
          <label className='relative cursor-pointer'>
            ...
            <div className='w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-500 transitiom'> </div>
